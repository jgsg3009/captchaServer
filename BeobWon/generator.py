...
def build_generator(g_power,img_shape):
    ...
    d0_1 = conv2d_bn_relu(x = d0_0, filters = g_power, kernel_size=(4, 4), weight_decay=1e-4, strides=(1, 1))
    d0_2 = ResidualBlock(x = d0_1, filters = g_power, kernel_size = (4, 4), weight_decay = 1e-4, downsample = False)
    # Downsampling
    d1_1 = ResidualBlock(x = d0_2, filters = g_power*2, kernel_size = (4, 4), weight_decay = 1e-4, downsample = True)
    d1_2 = ResidualBlock(x = d1_1, filters = g_power*2, kernel_size = (4, 4), weight_decay = 1e-4, downsample = False)
    d2_1 = ResidualBlock(x = d1_2, filters = g_power*4, kernel_size = (4, 4), weight_decay = 1e-4, downsample = True)
    d2_2 = ResidualBlock(x = d2_1, filters = g_power*4, kernel_size = (4, 4), weight_decay = 1e-4, downsample = False)
    d3_1 = ResidualBlock(x = d2_2, filters = g_power*6, kernel_size = (4, 4), weight_decay = 1e-4, downsample = True)
    d3_2 = ResidualBlock(x = d3_1, filters = g_power*6, kernel_size = (4, 4), weight_decay = 1e-4, downsample = False)
