...
from . solver import ResNet18_5_Parted_NoPooling as build_solver
import cv2
import numpy as np
...
class PredictCaptcha():
    def __init__(self) :
        ...
        self.generator.load_weights('./MinWon24/generator_weights.h5')
        self.solver.load_weights('./MinWon24/solver_weights.h5')
