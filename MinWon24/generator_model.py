...
def build_generator(g_power, img_shape):
    ...
    output_img = ResidualBlockLast(
        x=u3_3, filters=img_shape[-1], kernel_size=(4, 4), weight_decay=1e-4, downsample=False)
    output_img = Conv2D(img_shape[-1], kernel_size=4, strides=1,
