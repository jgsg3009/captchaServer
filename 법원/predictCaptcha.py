...
class PredictCaptcha():
    def __init__(self) :
        ...
        self.generator = build_generator(g_power = 120, img_shape = self.img_shape)
        self.solver = build_solver(input_shape=self.img_shape, size = 1, classes=10, weight_decay=5e-4)
